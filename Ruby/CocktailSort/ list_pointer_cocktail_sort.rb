...
if ARGV.size < 2
  puts "Uso: ruby list_pointer_cocktail_sort.rb <arquivo.csv> <N>"
  exit
end

path = ARGV[0]
n = ARGV[1].to_i
lista = ListPointerCocktailSort.new
...
time = Benchmark.realtime { lista.cocktail_sort }
